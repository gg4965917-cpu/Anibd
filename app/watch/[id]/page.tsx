...
export async function generateMetadata(
  ...
  return {
    title: `Дивитися ${anime.title} українською онлайн`,
    ...
    <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
        <div>
          ...
          {anime.titleJapanese && anime.titleJapanese !== anime.titleRomaji && (
            <div className="text-xs text-slate-500">{anime.titleJapanese}</div>
          )}
          {anime.synopsis && (
